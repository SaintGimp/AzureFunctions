...
public static async Task Run(TimerInfo myTimer, TraceWriter log)
{
    ...
    log.Info($"Most recent timestamp in GOES is {samples.Last().Timestamp}");
    log.Info($"Most recent timestamp in ElasticSearch is {mostRecentTimestamp}");
    log.Info($"Saving {samplesToLoad.Count()} new samples");
